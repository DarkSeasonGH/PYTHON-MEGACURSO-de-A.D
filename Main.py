...
a partir de unos apuntes mios de obsidian, lo he hecho lo mas 
...
# a tener que importarla arriba del código
...
#44.MANIPULAR EL TIEMPO CON TIME
...
#Upper es un metodo para transformar una cadena de texto minuscula en mayuscula

cadena_texto = "cadena de texto"

cadena_texto_upper = cadena_texto.upper()

print("La cadena de texto pasada a mayuscula es: ")
...
# 75. Desempaquetado de secuencias
...
#85.ARGUMENTOS PREDETERMINADOS EN FUNCIONES
...
#92.GZIP COMPRESION DE ARCHIVOS
...
#94.SMTPLIB es para mandar mensajes por mail
